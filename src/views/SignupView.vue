                ...
                <ion-col size-sm="10" size-md="8" size-lg="6" offset-sm="1" offset-md="2" offset-lg="3">
                    <ion-card>
                        <ion-card-header>
                            ...
                            <ion-card-subtitle>Meld u aan om een account aan te maken en uw voortgang
                                bij te houden</ion-card-subtitle>
                        </ion-card-header>
                        <ion-card-content>
                            <ion-input placeholder="E-mail" type="email" v-model="email"
                                label="Mailadres: "></ion-input>
                            <ion-input placeholder="Wachtwoord" type="password" v-model="password"
                                label="Wachtwoord: "></ion-input>
