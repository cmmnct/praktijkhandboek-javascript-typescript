                ...
                <ion-list>
                    ...
                    <ion-item>
                        ...
                        <ion-modal :keep-contents-mounted="true">
                            <ion-datetime id="datetime" v-model="myUserCredentials.birthdate"
                                display-format="YYYY-MM-DD" presentation="date"
                                @ionChange="atSettingsChange"></ion-datetime>
                        </ion-modal>
                    </ion-item>
                </ion-list>
            <!-- Update Profiel Knop -->
                ...
                <ion-list v-if="changePassword">
                    ...
                    <ion-grid>
                        <ion-row>
                            ...
                            <ion-col>
                                <ion-button expand="block" :disabled="!checkPasswords()"
                                    @click="handleUpdateProfile()">Update Wachtwoord</ion-button>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-list>
...
function checkPasswords(): boolean {
    if (myUserCredentials.oldPassword && myUserCredentials.newPassword &&
        myUserCredentials.oldPassword !== myUserCredentials.newPassword) {
        passwordError.value = '';
        console.log("goed!")
        return true;
    } else {
